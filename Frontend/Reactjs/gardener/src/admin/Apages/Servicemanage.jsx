...
function Servicemanage() {
  ...
  return (
    <div>
      <Aheader />
      <Apages title="Service Management" data="Service" />
          ...
          <tbody>
            {
              ...
              <td>{data.logo}</td> */}
                    <td>
                      <button className='btn btn-info' onClick={() => singlservice(data.id)}>Veiw</button>
                ...
                <div className="col-12 wow fadeIn" data-wow-delay="0.1s">
                  ...
                  <form >
                    <div className="row g-3">
                      ...
                      <div className="col-6">
                        <div className="form-floating">
                          <input type="url" onChange={getchange} value={edited.image} name='image' className="form-control" id="image" placeholder="your images" />
                      ...
                      <div className="col-12">
                        <div className="form-floating">
                          <textarea className="form-control" onChange={getchange} value={edited.des} name='desc' placeholder="your descrition" id="message" style={{ height: 100 }} defaultValue={""} />
